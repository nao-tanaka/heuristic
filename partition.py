...
class Block:
    ...
    def __init__(self, total_cell_size, max_free_cell_size, block_size_ratio, min_cell_num_constraint, which_block):
        ...
        self.__min_cell_num_constraint = cell_num_constraint
        self.__which_block = which_block
...
def update_naighbor_gain(base_cell, free_cell_set, bucket_sort):
...
def partition(cutset, free_cell_set, init_cell_list, block_a, block_b, bucket_sort, network, WhichBlock):
    ...
    while True:
        ...
        if basecell is not None:
            ...
            cell.switch_block(next_block)

            # ベースセルの隣人のゲインを更新
            update_neighbor_gain(basecell, free_cell_set, bucket_sort)
            ...
            return cutset, min_cutset_size_in_pass, min_cutset_block_a_in_pass, min_cutset_block_b_in_pass
